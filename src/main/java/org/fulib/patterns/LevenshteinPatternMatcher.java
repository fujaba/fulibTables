 ...
 */
public class LevenshteinPatternMatcher
{
   // =============== Fields ===============
    ...
    *    the pattern
    */
   public LevenshteinPatternMatcher(Pattern pattern)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootPatternObjects(PatternObject patternObject)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootPatternObjects(PatternObject... patternObjects)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootPatternObjects(Collection<? extends PatternObject> patternObjects)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootObjects(Object object)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootObjects(Object... objects)
   {
    ...
    * @since 1.3
    */
   public LevenshteinPatternMatcher withRootObjects(Collection<?> objects)
   {
